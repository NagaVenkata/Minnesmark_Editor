...
public class MmObjWriter {
	...
	public void beginSave(String fn) {
	 ...
	 public void endSave() {
	   ...
	   public void faceWithNormals(MmVec3 vec,MmVec3 vec1,MmVec3 vec2,MmVec3 vec3)
	   {
		   objWriter.println("f " + (int)vec.x + "/" + (int)vec.y + "/"+(int)vec.z + " " +(int)vec1.x+ "/" +(int)vec1.y + "/" + (int)vec1.z
	                + " " + (int)vec2.x+"/"+(int)vec2.y+"/"+(int)vec2.z+" "+(int)vec3.x+"/"+(int)vec3.y+"/"+(int)vec3.z);
	   }
	    ...
	    {
	    	vertex(new MmVec3(0.984484f, 1.015231f,-0.030518f));
	    	vertex(new MmVec3(1.015181f, -0.984533f, -0.030566f));
	    	vertex(new MmVec3(1.015273f, -0.984533f, 0.027363f));
	    	vertex(new MmVec3(0.984575f, 1.015231f, 0.027412f));
	    	
	    	
	    	vertex(new MmVec3(-1.015273f, 0.984533f, -0.027363f));
	    	vertex(new MmVec3(-1.015181f, 0.984533f, 0.030566f));
	    	vertex(new MmVec3(-0.984484f, -1.015231f, 0.030518f));
	    	vertex(new MmVec3(-0.984575f, -1.015232f, -0.027412f));
	    ...
	    {
	    	faceWithNormals(new MmVec3(1f, 1f,1f),new MmVec3(2f, 2f,1f),new MmVec3(3f, 3f,1f),new MmVec3(4f, 4f,1f));
	    	faceWithNormals(new MmVec3(5f, 1f,2f),new MmVec3(6f, 2f,2f),new MmVec3(7f, 3f,2f),new MmVec3(8f, 4f,2f));
	    	faceWithNormals(new MmVec3(1f, 1f,3f),new MmVec3(5f, 2f,3f),new MmVec3(8f, 3f,3f),new MmVec3(2f, 4f,3f));
	    	faceWithNormals(new MmVec3(2f, 1f,4f),new MmVec3(8f, 2f,4f),new MmVec3(7f, 3f,4f),new MmVec3(3f, 4f,4f));
	    	faceWithNormals(new MmVec3(3f, 1f,5f),new MmVec3(7f, 2f,5f),new MmVec3(6f, 3f,5f),new MmVec3(4f, 4f,5f));
	    	faceWithNormals(new MmVec3(5f, 1f,6f),new MmVec3(1f, 2f,6f),new MmVec3(4f, 3f,6f),new MmVec3(6f, 4f,6f));
	    }
	    ...
	    public void writeMtl()
	    {
	        ...
	        try {
	              ...
	              objWriter1.println("# Material Count " + 1);
